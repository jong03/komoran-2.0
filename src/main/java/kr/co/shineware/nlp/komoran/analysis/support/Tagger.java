...
public class Tagger {
	...
	public static boolean parse(Model model, Lattice lattice) {
		return MeCabJNI.Tagger_parse__SWIG_0(Model.getCPtr(model), model,
				Lattice.getCPtr(lattice), lattice);
	}

	public boolean parse(Lattice lattice) {
		return MeCabJNI.Tagger_parse__SWIG_1(swigCPtr, this,
				Lattice.getCPtr(lattice), lattice);
	}
	...
	public String formatNode(Node node) {
		return MeCabJNI.Tagger_formatNode(swigCPtr, this, Node.getCPtr(node),
				node);
	}
	...
	public static Tagger create(int argc, SWIGTYPE_p_p_char argv) {
		long cPtr = MeCabJNI.Tagger_create__SWIG_0(argc,
				SWIGTYPE_p_p_char.getCPtr(argv));
	...
	public String parseToString(String str, long length) {
		return MeCabJNI.Tagger_parseToString__SWIG_0(swigCPtr, this, str,
				length);
	}
