...
public final class PosIdManager {
	 ...
	 */
	public enum PosId {
		UNKNOWN(0), COMPOUND(1), INFLECT(2), PREANALYSIS(3), E(100), IC(110), J(
				120), MAG(130), MAJ(131), MM(140), N(150), SF(160), SH(161), SL(
				162), SN(163), SP(164), SSC(165), SSO(166), SU(167), SY(168), VA(
				170), VCN(171), VCP(172), VV(173), VX(174), XPN(181), XR(182), XSA(
				183), XSN(184), XSV(185), EOJEOL(900);
		...
		public static PosId convertFrom(int posIdNum) {
			...
			case 1:
				return PosId.COMPOUND;
			case 2:
				return PosId.INFLECT;
			case 3:
				return PosId.PREANALYSIS;
			case 100:
				return PosId.E;
			case 110:
				return PosId.IC;
		...
		public boolean in(PosId start, PosId end) {
			return start.getNum() <= this.getNum()
					&& this.getNum() <= end.getNum();
		}
	}
}