...
class MeCabJNI {
	public final static native String DictionaryInfo_filename_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native String DictionaryInfo_charset_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native long DictionaryInfo_size_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native int DictionaryInfo_type_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native long DictionaryInfo_lsize_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native long DictionaryInfo_rsize_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native int DictionaryInfo_version_get(long jarg1,
			DictionaryInfo jarg1_);

	public final static native long DictionaryInfo_next_get(long jarg1,
			DictionaryInfo jarg1_);
	...
	public final static native void Path_prob_set(long jarg1, Path jarg1_,
			float jarg2);
	...
	public final static native void Node_prob_set(long jarg1, Node jarg1_,
			float jarg2);
	...
	public final static native boolean Lattice_is_available(long jarg1,
			Lattice jarg1_);
	...
	public final static native long Lattice_end_nodes(long jarg1,
			Lattice jarg1_, long jarg2);

	public final static native long Lattice_begin_nodes(long jarg1,
			Lattice jarg1_, long jarg2);

	public final static native String Lattice_sentence(long jarg1,
			Lattice jarg1_);

	public final static native long Lattice_size(long jarg1, Lattice jarg1_);

	public final static native void Lattice_set_Z(long jarg1, Lattice jarg1_,
			double jarg2);

	public final static native double Lattice_Z(long jarg1, Lattice jarg1_);

	public final static native void Lattice_set_theta(long jarg1,
			Lattice jarg1_, float jarg2);
	...
	public final static native int Lattice_request_type(long jarg1,
			Lattice jarg1_);

	public final static native boolean Lattice_has_request_type(long jarg1,
			Lattice jarg1_, int jarg2);

	public final static native void Lattice_set_request_type(long jarg1,
			Lattice jarg1_, int jarg2);

	public final static native void Lattice_add_request_type(long jarg1,
			Lattice jarg1_, int jarg2);

	public final static native void Lattice_remove_request_type(long jarg1,
			Lattice jarg1_, int jarg2);

	public final static native String Lattice_toString__SWIG_0(long jarg1,
			Lattice jarg1_);

	public final static native String Lattice_toString__SWIG_1(long jarg1,
			Lattice jarg1_, long jarg2, Node jarg2_);

	public final static native String Lattice_enumNBestAsString(long jarg1,
			Lattice jarg1_, long jarg2);

	public final static native String Lattice_what(long jarg1, Lattice jarg1_);

	public final static native void Lattice_set_what(long jarg1,
			Lattice jarg1_, String jarg2);

	public final static native void delete_Lattice(long jarg1);

	public final static native long new_Lattice();

	public final static native void Lattice_set_sentence(long jarg1,
			Lattice jarg1_, String jarg2);

	public final static native long Model_dictionary_info(long jarg1,
			Model jarg1_);
	...
	public final static native boolean Model_swap(long jarg1, Model jarg1_,
			long jarg2, Model jarg2_);
	...
	public final static native boolean Tagger_parse__SWIG_0(long jarg1,
			Model jarg1_, long jarg2, Lattice jarg2_);

	public final static native boolean Tagger_parse__SWIG_1(long jarg1,
			Tagger jarg1_, long jarg2, Lattice jarg2_);

	public final static native String Tagger_parse__SWIG_2(long jarg1,
			Tagger jarg1_, String jarg2);

	public final static native long Tagger_parseToNode(long jarg1,
			Tagger jarg1_, String jarg2);

	public final static native String Tagger_parseNBest(long jarg1,
			Tagger jarg1_, long jarg2, String jarg3);

	public final static native boolean Tagger_parseNBestInit(long jarg1,
			Tagger jarg1_, String jarg2);
	...
	public final static native String Tagger_formatNode(long jarg1,
			Tagger jarg1_, long jarg2, Node jarg2_);

	public final static native void Tagger_set_request_type(long jarg1,
			Tagger jarg1_, int jarg2);
	...
	public final static native void Tagger_set_partial(long jarg1,
			Tagger jarg1_, boolean jarg2);

	public final static native int Tagger_lattice_level(long jarg1,
			Tagger jarg1_);

	public final static native void Tagger_set_lattice_level(long jarg1,
			Tagger jarg1_, int jarg2);

	public final static native boolean Tagger_all_morphs(long jarg1,
			Tagger jarg1_);

	public final static native void Tagger_set_all_morphs(long jarg1,
			Tagger jarg1_, boolean jarg2);

	public final static native void Tagger_set_theta(long jarg1, Tagger jarg1_,
			float jarg2);

	public final static native float Tagger_theta(long jarg1, Tagger jarg1_);

	public final static native long Tagger_dictionary_info(long jarg1,
			Tagger jarg1_);
	...
	public final static native String Tagger_parseToString__SWIG_0(long jarg1,
			Tagger jarg1_, String jarg2, long jarg3);

	public final static native String Tagger_parseToString__SWIG_1(long jarg1,
			Tagger jarg1_, String jarg2);
