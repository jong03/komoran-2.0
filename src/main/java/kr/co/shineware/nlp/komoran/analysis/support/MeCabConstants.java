...
public interface MeCabConstants {
	...
	public final static int MECAB_MARGINAL_PROB = MeCabJNI
			.MECAB_MARGINAL_PROB_get();
	public final static int MECAB_ALTERNATIVE = MeCabJNI
			.MECAB_ALTERNATIVE_get();
	public final static int MECAB_ALL_MORPHS = MeCabJNI.MECAB_ALL_MORPHS_get();
	public final static int MECAB_ALLOCATE_SENTENCE = MeCabJNI
			.MECAB_ALLOCATE_SENTENCE_get();
